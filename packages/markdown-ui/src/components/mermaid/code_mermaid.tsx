...
export const MermaidPreviewPane = defineComponent({
  ...
  props: {
    ...
    beautifulOptions: { type: Object, required: false },
    renderSvg: { type: Boolean, required: false, default: true },
    className: {
      type: String,
      required: false,
    ...
    streamPendingText: { type: String, required: false },
    loadingDelayMs: { type: Number, required: false },
    minLoadingMs: { type: Number, required: false },
    streamErrorGraceMs: { type: Number, required: false },
    workerFactory: {
